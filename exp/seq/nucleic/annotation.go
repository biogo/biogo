...
// An Annotation is a basic nucleic acid sequence annotation type.
...
// SetAlphabet the sets the alphabet.Nucleic used by the sequence.
func (a *Annotation) SetAlphabet(n alphabet.Nucleic) { a.Alpha = n }
...
// Nucleic is a no-op method required to satisfy nucleic.Sequence interface.
func (a *Annotation) Nucleic() {}
